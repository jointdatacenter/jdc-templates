...
logo: _extensions/jdc/jdc_logo_horizontal_white.png
---
...
## Your Slide Title {.slide-blue .jdc-background}

Blue slide with custom background
...
A section starts with a level 1 heading (`# Section 1`).
